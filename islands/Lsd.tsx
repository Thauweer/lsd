    ...
    return (
        <div
            ...
            <div class="flex flex-row items-center p-20 bg-gray-800 rounded-2xl">
                ...
                <img src="https://cdn.discordapp.com/icons/422325987481747457/913f45a38e006f83628577e669456c57.webp?size=480" alt="lsd" class="rounded-full inline ml-5 w-20 sm:w-24 md:w-28 lg:w-32 xl:w-36 animate-pulse" />
            </div>
        </div>
    )
}
